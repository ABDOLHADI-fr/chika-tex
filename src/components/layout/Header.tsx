        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden lg:flex items-center gap-1">
              ...
              <Link
                href={`/${otherLocale}`}
                className="ml-2 px-4 py-2 rounded-lg text-sm font-medium border border-gray-300 text-gray-700 hover:border-red-600 hover:text-red-600 transition-colors"
              >
                {switchLabel}
              </Link>
            </nav>
          ...
          <div className="lg:hidden border-t border-gray-200 bg-white">
            <div className="max-w-7xl mx-auto px-4 py-4 space-y-2">
              ...
              <Link
                href={`/${otherLocale}`}
                onClick={closeMenu}
                className="block px-4 py-3 rounded-lg text-sm font-medium border border-gray-300 text-gray-700 hover:border-red-600 hover:text-red-600 transition-colors mt-2"
              >
                {switchLabel}
              </Link>
            </div>
